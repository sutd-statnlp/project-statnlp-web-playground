(function () {
    ...
    MaltextController.$inject = ['$scope', '$state', '$mdDialog'];

    function MaltextController($scope, $state, $mdDialog) {
        var vm = this;
        ...
        $(document).ready(function () {
            ...
            d3.tsv("content/data/maltext-data-1.tsv", function (files) {
            ...
            function treemap(root) {
                ...
                function clickNode(d) {
                    if (d.children.length === 0) {
                        var path = 'content/data/maltext/' + d.parent.name + '/' + d.name;
                        showText(path, d.name);
                    }
                }
            };
